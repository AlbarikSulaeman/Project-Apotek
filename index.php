...
?>
    ...
    <header>
      <nav>
        <div class="top-header">
          ...
          <div class="nav-icons">
            <span>Tamu</span><i class="fas fa-user"></i>
          </div>
        </div>
    ...
    <table>
     <div style="height: 700px; overflow: scroll; padding-right: 25px; padding-left: 25px; justify-items: center;">      
    <?php  
      while ($prod = mysqli_fetch_array($item)) {
        $fproduk = "foto_produk/" . $prod['foto_produk'];
          echo "<div class = 'prod-cont' style='height: 350px;margin-left: 10px;'><div style='height: 300px;'><div><img src='$fproduk'  height= '100px' class='foto-produk-jual'></div>"; 
